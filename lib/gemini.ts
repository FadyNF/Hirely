...
const EMPLOYEE_EXTRACTION_SCHEMA = {
  ...
  properties: {
    ...
    workLocation: { type: "string", description: "The employee's work location, office, or branch — e.g. \"Cairo, Egypt\". Only set this when the message is actually about where they work. Never put a person's name here." },
    ...
    experience: {
      ...
      items: {
        ...
        properties: {
          ...
          endDate: { type: "string", description: "When this specific role ended — use \"Present\" if it's their current role." },
...
const FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  email: "An email address, must contain '@' (e.g. name@company.com). Never a phone number.",
  workLocation: "A work location or office name.",
